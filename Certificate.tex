...
\begin{tabular}{p{0.3\textwidth}p{0.3\textwidth}p{0.3\textwidth}}
	& &\\
	& &\\
	\centering Guide &\centering Head of the Department &\centering Principal\tabularnewline
	& &\\
	\centering\printGuideNameA & \centering\printHOD & \centering\printPrincipal\tabularnewline
	& & \\
\end{tabular}
\end{table}
\fi % \ifIDP
